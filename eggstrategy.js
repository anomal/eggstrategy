...
function run() {
	...
	document.getElementById("totalBlueIncubators").innerHTML = "➜ Total blue incubators received at the end: <strong>" + (+startingBlueIncubators + Math.floor(totalKmWalked/distanceTravelledToGetNewIncubator)) + "</strong>";
